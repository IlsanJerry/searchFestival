...
<div id="view" class="container">
    <div class="row">
        ...
        <legend>마이페이지</legend>
        	<table>
				<tr onclick="location.href='http://70.12.113.165:8000/festival/adminpage/notice?action=list'">
				<td>공지사항 관리</td>
				</tr>
				<tr onclick="location.href='http://70.12.113.165:8000/festival/adminpage/report'">
				<td>리뷰 신고함</td>
				</tr>
			</table>
			</fieldset>
				...
				<c:when test="${!empty noticelist }">
					...
					<table class="table table-stripaed">
						...
						<c:forEach var="vo" items="${noticelist }">
							<tr id="list_title">
								<td>${vo.nid }</td>
								<td onclick="location.href='http://70.12.113.165:8000/festival/adminpage/ncontent?nid=${vo.nid}'">${vo.title }</td>
								<td>${vo.writer }</td>
								<td>${vo.uploaddate }</td>
								<td>${vo.cnt }</td>
							</tr>
